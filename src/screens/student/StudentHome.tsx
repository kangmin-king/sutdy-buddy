...
import { buildStudentHomeModel, canStartStudyItem, deriveRunningSessionIds, filterOpenRunningSessions, findStaleRunningSessions } from './studentHomeModel';
    ...
    <div className="px-5 pt-4 pb-[calc(7rem+env(safe-area-inset-bottom))]">
      ...
      */}
      ...
      <TodayList
        ...
        isRunning={(itemId) => Boolean(openRunningSessionId[itemId])}
        canStart={(itemId) => canStartStudyItem(openRunningSessionId, itemId)}
